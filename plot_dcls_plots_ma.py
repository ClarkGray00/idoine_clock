...
custom_cmap = LinearSegmentedColormap.from_list("green_black", ["purple", "black"])
...
filenames = [
             'briggs_rauscher_run11_700c_0_5e_86p_1a_0i_DCLS',
             'briggs_rauscher_run1_700c_0_5e_86p_1a_0i_DCLS',
             'briggs_rauscher_run10_700c_0_5e_86p_1a_0i_DCLS',
             'briggs_rauscher_run12_700c_0_5e_86p_1a_0i_DCLS',]
...
legend_names = ['0.1M','0.15M','0.2M','0.25M']
...
for i in range(len(filenames)):
    ...
    plt.text(680, -i+0.5, legend_names[i], fontsize=15,fontweight='bold',color=colors[i],ha='right', va='center')
...
plt.savefig('7_figures/' + 'DCLS_ma_BR' + '_plot.png', dpi=700)
plt.show()
...
plt.xlim(30,140)
plt.savefig('7_figures/' + 'DCLS_ma_BR_zoomed' + '_plot.png', dpi=700)
